...
const initialState = {
    turnedPages: { 1: true, 2: true, 3: true, 4: true },
    zIndexes: { 1: 20, 2: 21, 3: 22, 4: 23 },
    coverTurned: false,
    coverZIndex: 100,
};
    ...
    return (
        ...
        >
            <div className="page-front" id={frontId}>
                <FrontComponent />
                <span className="number-page">{frontPageNum}</span>
            ...
            <div className="page-back" id={backId}>
                <BackComponent />
                <span className="number-page">{backPageNum}</span>
